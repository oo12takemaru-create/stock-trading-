...
const INTRADAY = {
  ...
  from: "09:00",
  // 大引け（15:00）のあと、終値が出そろう時間帯まで見る。
  // 2026-09-10: 15:45 → 16:15 に延長（引継ぎ.md §23 相談⑪(2)）。
  //   cron-job.org の Realtime Scan は実測で JST 16:45 まで叩いていた（手順書は 15:45）。
  //   それを Worker へ寄せるにあたり、**16:00 と 16:15 は引き継ぎ、16:30・16:45 は捨てる**
  //   という判断（Fable）。捨てる2回は引け後のパイプライン（18:00）が拾う。
  to: "16:15",
};
